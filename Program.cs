    ...
    switch (menuSelection){
            ...
            if (os.Contains("Windows")){
                ...
                switch (basicVM)
                {
                    case "1":
                    {
                        ...
                        winazvmubuntu2204ssh.StartInfo.FileName = "";
                    ...
                    case "2": {
                        ...
                        winazvmwindows11.StartInfo.FileName = "";
                    ...
                    case "3": {
                        ...
                        winazvmwindowsserver2022.StartInfo.FileName = "";
            ...
            if (os.Contains("Windows")){
                ...
                switch (basicAKS)
                {
                    case "1": {
                        ...
                        winazakspublickubenetlb.StartInfo.FileName = "";
                    ...
                    case "2": {
                        ...
                        winazakspublicazurecnilb.StartInfo.FileName = "";
            ...
            switch (scenarioACT){
                ...
                case "1": {
                    if (os.Contains("Windows")){
                        ...
                        azaksKubenetUdrFw.StartInfo.FileName = "";
                ...
                case "2": {
                    ...
                    if (os.Contains("Windows")){
                        ...
                        azaksKubenetUdrFwprivate.StartInfo.FileName = "";
                ...
                case "3": {
                    ...
                    if (os.Contains("Windows")){
                        ...
                        azaksAzureCniUdrFw.StartInfo.FileName = "";
                ...
                case "4": {
                    if (os.Contains("Windows")){
                        ...
                        azaksAzureCniUdrFwprivate.StartInfo.FileName = "";
            ...
            switch (scenarioARC){
                ...
                case "2": {
                    ...
                    if (os.Contains("Windows")){
                        ...
                        aksArcAppServiceExt.StartInfo.FileName = "";
                ...
                case "3": {
                    ...
                    if (os.Contains("Windows")){
                        ...
                        aksArcAppServiceExtWebApp.StartInfo.FileName = "";
                ...
                case "4": {
                    if (os.Contains("Windows")){
                        ...
                        upstreamKubernetes.StartInfo.FileName = "";
        ...
        case "6": {
            ...
            if (os.Contains("Windows")){
                ...
                azgroupdelete.StartInfo.FileName = "";
